...
CREATE TABLE public.staff (
    id integer NOT NULL,
    name character varying(20) DEFAULT 'unknown'::character varying NOT NULL,
    pwd character varying(100) DEFAULT 'unknown'::character varying NOT NULL,
    email character varying(100) DEFAULT 'unknown'::character varying NOT NULL,
    gender character varying(100) DEFAULT 'unknown'::character varying NOT NULL
);
...
COPY public.staff (id, name, pwd, email, gender) FROM stdin;
